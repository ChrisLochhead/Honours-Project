...
using UnityEngine;
using MLAgents;
public class ReinforcementAction : Agent
{
    ...
    ReinforcementNavigation navigationNetwork;
    ...
    public override void AgentAction(float[] vectorAction, string textAction)
    {
         ...
         */
        if (brain.brainParameters.vectorActionSpaceType == SpaceType.continuous && isInActionPhase)
        {
